---
title: "Vex Open Source Checklist"
description: "This document tracks what needs to be done before pushing to the public chrryai/vex repository."
---
...
Follow the guide: [.github/SYNC_SETUP.md](https://github.com/chrryai/sushi/blob/main/.github/SYNC_SETUP.md)
