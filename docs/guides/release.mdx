...
description: "How to build, distribute, and publish desktop applications for the Vex ecosystem."
---
...
3. **Update download links**
   ...
   - Example: `https://github.com/chrryai/vex/releases/download/v1.8.47/Vex_0.1.0_aarch64.dmg`
