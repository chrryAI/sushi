...
Chrry is a recursive app composition platform. It provides the chassis; you provide the intelligence.

## The logic: 70/30 split (BYOK)

This is a sovereign architecture. Your compute is not subsidized, and your upside is not capped.
