---
title: "Standalone apps migration"
description: "Migration guide for packaging each app as a standalone Tauri desktop application."
---

## Overview

Each app was migrated to be packaged as a separate standalone Tauri desktop application. This gives every app its own desktop installer.
...
### 3. Bloom - wellness and sustainability coach
...
### 6. Nebula - science and exploration hub
...
- **@chrryai/machine**: Shared database layer and seed data
...
- **App Store ready** - Each app can be submitted to Mac App Store and Windows Store separately
...
3. **App Store**: Each app can be submitted separately to Mac/Windows stores
