---
title: "Apps migration summary"
description: "Summary of migrating app seeding logic from a monolithic file to decentralized, modular seed functions."
---

## Completed migration

This migration moved hardcoded app seeding logic from the monolithic `createStores.ts` (9356 lines) to individual app files in `packages/machine/src/dna/apps/`.
...
### 5. Focus - productivity assistant
...
**Before**: 9356-line monolith, difficult to maintain  
