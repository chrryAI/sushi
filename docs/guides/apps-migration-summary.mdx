---
title: "Apps Migration Summary - Decentralized Seeding"
description: "Successfully migrated hardcoded app seeding logic from the monolithic createStores.ts (9356 lines) to individual app files in packages/machine/src/dna/apps/."
---
