...
description: "Highest-impact, lowest-effort SEO fixes ranked by priority for the Vex web app."
---

Below are the highest-impact SEO fixes ranked by effort vs. reward:

## Quick wins (5 min each)

### 1. Fix sitemap - remove non-canonical pages

**Impact**: High (Fixes 51 pages)  
**Effort**: Low (One file edit)
...
**Impact**: Medium (Helps 288 pages get indexed)  
**Effort**: Medium (Requires some thought)
...
A script can be created to automatically:

- Scan for multiple H1s
- Generate a sitemap without localized pages
- Add null checks to event listeners

---

**Summary**: Fix the sitemap first. It takes 5 minutes and fixes 51 pages.
