---
title: "Focus custom domain configuration"
description: "Configure custom domains, metadata, and branding for the Focus standalone site mode."
---

## Overview

Focus has its own **separate site mode** with custom domain support, independent metadata, and dedicated app configuration.
...
focus: {
  ...
  tr: "Focus - AI Productivity Assistant",
}
```
...
- Add "focus" siteMode type
- Add Focus translations (10 languages)
- Add Focus domain detection
- Add Focus site configuration
- Update validModes array
...
Focus runs as a standalone productivity app with dedicated branding and domain.
