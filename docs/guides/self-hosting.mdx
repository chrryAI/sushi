---
title: "Self-hosting Vex - Local Development Guide"
description: "Run Vex entirely on your local machine with Docker containers."
---
...
MIT - See [LICENSE](https://github.com/chrryai/sushi/blob/main/LICENSE) for details.
