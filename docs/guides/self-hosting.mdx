---
title: "Self-hosting Vex"
description: "Run Vex entirely on your local machine with Docker containers for local development."
---
...
See the deployment guide in the repository for full production setup instructions.
...
AGPL-3.0 - See the LICENSE file in the repository for details.
