---
title: "Platform Styles - Auto-mapping classname to React Native"
description: "Your platform primitives now automatically convert className to React Native styles on native platforms!"
---
