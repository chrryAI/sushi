...
Synchronize SonarCloud code quality data into the **FalkorDB graph database** to:

- Enable the RAG system to provide insights on code quality
- Associate code files with their issues
- Perform topic-based searches (security, performance, code-smell, etc.)
- Run hotspot analysis (files with the most issues)
