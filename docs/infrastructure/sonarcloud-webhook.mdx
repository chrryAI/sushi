---
title: "SonarCloud webhook integration"
description: "Setup and configuration for the SonarCloud webhook endpoint that provides real-time code quality metrics and issue tracking."
---
...
3. The endpoint verifies the signature before processing
