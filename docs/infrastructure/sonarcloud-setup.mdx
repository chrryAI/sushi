---
title: "Sonarcloud Integration Summary"
description: "Since SonarCloud webhooks require a Team or Enterprise plan ($32+/month), we're using a polling-based approach with cron jobs."
---
