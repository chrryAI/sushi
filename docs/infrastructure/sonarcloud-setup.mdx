---
title: "SonarCloud integration setup"
description: "Overview of the SonarCloud integration using polling-based sync with cron jobs, including webhook-ready endpoint for future upgrades."
---

## Current setup: manual polling (free plan)

Since SonarCloud webhooks require a **Team or Enterprise plan** ($32+/month), the setup uses a **polling-based approach** with cron jobs.
