...
An advertising model built into Vex where users **choose** when to see ads and get **paid directly** for their attention.
...
Grape Platform:
- Grape emoji integration in Vex
- Ad viewer UI
- Grape Wallet
- Payment processing
...
Grape aims to help users reclaim their attention from involuntary advertising.
...
A: Rate them 1-star. The algorithm learns and improves matching. You can also block brands and adjust interests anytime.

### For advertisers

**Q: Why pay more per view?**
A: Because engagement is 10-30x higher. Users voluntarily chose to see your ad. They're paying attention. Conversion rates are higher than for forced ads.
...
A: Video (15-60s), interactive demos, product showcases, surveys, games. More formats are planned.
...
A: Yes. Grape provides APIs for researchers, developers, and integrators. Licensed under MIT.

**Q: Can I fork Grape?**
A: Yes, under MIT terms. You are free to modify and distribute.

**Q: How do I integrate Grape with my app?**
A: Use the Grape SDK. Track ad exposure in your app. Offer Grape as alternative. Share revenue with users. See the partnership documentation for details.
...
**Grape is being built in public. Here's how you can help:**
...
Inspired by the quantified self movement, privacy-first technology, open source collaboration, and attention economy research.
