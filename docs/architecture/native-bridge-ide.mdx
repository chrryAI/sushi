---
title: "Native bridge IDE architecture"
description: "Browser-first AI-driven IDE architecture using the Vex Native Bridge for development workflows from a browser extension."
---

## Vision

The **Vex Native Bridge** enables a browser-first, AI-driven IDE that turns your browser extension into a complete development environment. Unlike traditional VS Code extensions that are isolated to the editor, Vex leverages its position as a LifeOS overlay to provide contextual development workflows.
...
2. **No context switch**: IDE overlays on any environment
...
2. **Low friction**: No app switching, instant overlay
...
The architecture enables AI-driven, browser-first coding workflows.
