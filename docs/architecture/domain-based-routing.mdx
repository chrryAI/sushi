---
title: "Domain-based Routing - Single Server Architecture"
description: "Consolidated from multiple servers to one server that automatically detects the domain and routes accordingly."
---
