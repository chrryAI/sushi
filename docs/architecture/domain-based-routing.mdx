...
description: "Single server architecture that automatically detects domains and routes requests to the correct application mode without environment variables."
---
...
All domains are served from a single server instance with domain-based routing.
