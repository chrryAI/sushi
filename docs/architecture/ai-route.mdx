---
title: "The AI Route: Universal Entry Point for AI Interactions"
description: "The /api/ai route is the single, unified entry point for all AI interactions in Chrry."
---
