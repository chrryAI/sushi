...
description: "Communication protocol definition for the Vex Native Bridge enabling secure local file system and CLI access from the browser extension."
---
...
1.  **Strict scope:** The Bridge must only operate within the user-configured Vex root directory (e.g., `~/Documents/vex`).
...
These endpoints enable the AI to execute developer workflows.
