---
title: "Native_bridge_api.md"
description: "This document defines the communication contract for the Vex Native Bridge, a local server component that grants the Vex Browser Extension (Client) secure, u..."
---
