      ...
      >
        ...
        >
          {post.images &&
            ...
            post?.images?.[0]?.url?.includes("hippo") && (
              <A
                href={`/p/${post.id}`}
                style={{
                  position: "relative",
              ...
              >
                <Img
                  ...
                  src={
                    (post?.images?.[0]?.sourceUrl ?? post?.images?.[0]?.url)
                      ? post.images[0].url
                      : undefined
                  }
                  slug={!post?.images?.[0]?.sourceUrl ? "coder" : undefined}
                />{" "}
              </A>
            )}
          {post?.videos?.[0]?.url?.includes("hippo") && (
            ...
            >
              <Video
                ...
                src={post?.videos?.[0]?.sourceUrl ?? post?.videos?.[0]?.url}
              />
            </Div>
          )}
