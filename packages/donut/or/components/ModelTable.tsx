            ...
            >
              <td>
                <div style={{ display: "flex", flexDirection: "column" }}>
                  <span style={{ fontWeight: "500", color: "var(--or-text)" }}>
                    {model.name}
                  </span>
                  <span
                    style={{
              ...
              <td>
                ...
                >
                  ...
                  >
                    {model.costTier.charAt(0).toUpperCase() +
                      model.costTier.slice(1)}
                  </span>
                  {model.pricing && (
                    <div
                      style={{
                    ...
                    >
                      In: {formatPrice(model.pricing.input)} | Out:{" "}
              ...
              <td>{renderFeatureTags(model.features)}</td>
              <td>
                <p
                  style={{
                    fontSize: "0.875rem",
