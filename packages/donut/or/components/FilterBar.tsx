import { Filter, Info, RotateCcw, Search } from "lucide-react"
    ...
    <div className="filter-bar">
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                onFilterChange("showMultimodal", e.target.checked)
              }
              style={{ width: "0.875rem", height: "0.875rem" }}
            />
            <span style={{ fontSize: "0.8rem", color: "var(--or-text)" }}>
              Multimodal only
            </span>
          </label>
          ...
          >
            ...
            >
              <input
                ...
                onChange={(e) =>
                  onFilterChange("showReasoning", e.target.checked)
                }
                style={{ width: "0.875rem", height: "0.875rem" }}
              />
              <span style={{ fontSize: "0.8rem", color: "var(--or-text)" }}>
          ...
          >
            ...
            >
              <input
                ...
                onChange={(e) =>
                  onFilterChange("showStreamCancel", e.target.checked)
                }
                style={{ width: "0.875rem", height: "0.875rem" }}
              />
              <span style={{ fontSize: "0.8rem", color: "var(--or-text)" }}>
          ...
          >
            <input
              ...
              onChange={(e) =>
                onFilterChange("hideExperimental", e.target.checked)
              }
              style={{ width: "0.875rem", height: "0.875rem" }}
            />
            <span style={{ fontSize: "0.8rem", color: "var(--or-text)" }}>
      ...
      >
        ...
        {filterStats.filtered < filterStats.total && (
          <span
            style={{ color: "var(--or-primary-color)", marginLeft: "1rem" }}
          >
