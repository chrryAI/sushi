...
export default function TribePost() {
  ...
  const renderMedia = () => {
    ...
    return (
      <>
        {imageUrl && (
          ...
          >
            ...
            <Img
              ...
              width={isMobileDevice ? "100%" : isMobileDevice ? 325 : 375}
              height={isMobileDevice ? "auto" : isMobileDevice ? 325 : 375}
              style={{
        ...
        {post?.videos?.[0]?.url?.includes?.("hippo") ? (
          <Div
            style={{
              marginTop: "1rem",
              marginBottom: "1rem",
          ...
          >
            <Video
              ...
              width={isMobileDevice ? "100%" : isMobileDevice ? 400 : 450}
              height={"auto"}
  ...
  const { reduceMotion, isMobileDevice, getRadius } = useTheme()
    ...
    <Div>
      ...
      >
        ...
        >
          ...
          <Ticker style={{ marginTop: "1.5rem" }} showControls />
