...
export const dojo = {
  blossom: {
    ...
    apps: [
      ...
      { slug: "donut", name: "Heart", emoji: "" },
    ],
  },
  lifeOs: {
    name: "LifeOS Lifestyle",
    apps: [
      { slug: "peach", name: "Peach", emoji: "🍑" },
      { slug: "bloom", name: "Bloom", emoji: "🌸" },
      { slug: "vault", name: "Vault", emoji: "💰" },
      { slug: "atlas", name: "Atlas", emoji: "🌍" },
    ],
  },
  sushi: {
    ...
    apps: [
      ...
      { slug: "jules", name: "Jules", emoji: "🐙" },
      { slug: "debugger", name: "Debugger", emoji: "🐛" },
      { slug: "architect", name: "Architect", emoji: "🏗️" },
      { slug: "coder", name: "Coder", emoji: "👩‍💻" },
      { slug: "writer", name: "Writer", emoji: "✍️" },
      { slug: "reviewer", name: "Reviewer", emoji: "🔍" },
      { slug: "researcher", name: "Researcher", emoji: "🔬" },
    ],
  },
  orbit: {
    name: "Science & Space (Orbit)",
    apps: [
      { slug: "nebula", name: "Nebula", emoji: "🌌" },
      { slug: "quantumlab", name: "QuantumLab", emoji: "⚛️" },
      { slug: "starmap", name: "StarMap", emoji: "🌠" },
      { slug: "cosmos", name: "Cosmos", emoji: "🧪" },
    ],
  },
  wine: {
    name: "Feedback & Ads (Wine)",
    apps: [
      { slug: "grape", name: "Grape", emoji: "🍇" },
      { slug: "pear", name: "Pear", emoji: "🍐" },
      { slug: "vault", name: "vault", emoji: "🤑" },
    ],
  },
  popcorn_cinema: {
    name: "Cinema Universe",
    apps: [
      { slug: "popcorn", name: "Popcorn", emoji: "🍿" },
      { slug: "fightClub", name: "Fight Club", emoji: "🫧" },
      { slug: "inception", name: "Inception", emoji: "🌀" },
      { slug: "pulpFiction", name: "Pulp Fiction", emoji: "🍔" },
      { slug: "hungerGames", name: "Hunger Games", emoji: "🔪" },
    ],
  },
  books_philosophy: {
    name: "Philosophy & Literature",
    apps: [
      { slug: "zarathustra", name: "Zarathustra", emoji: "🦋" },
      { slug: "1984", name: "1984", emoji: "👁️" },
      { slug: "meditations", name: "Meditations", emoji: "🏛️" },
      { slug: "dune", name: "Dune", emoji: "🏜️" },
    ],
  },
  nexus_grok: {
    name: "Grok Tribe (Nexus)",
    apps: [
      { slug: "grok", name: "Grok", emoji: "🤖" },
      { slug: "benjamin", name: "Benjamin", emoji: "🧐" },
      { slug: "harper", name: "Harper", emoji: "🎨" },
      { slug: "lucas", name: "Lucas", emoji: "🃏" },
    ],
  },
}
