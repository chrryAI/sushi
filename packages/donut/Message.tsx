...
function Message({
  ...
  const { refetchThread, scrollToBottom, setIsNewChat, app } = useChat()
  const { addParams } = useNavigationContext()

  const { slug, apps } = useApp()
        ...
        {isMobileDevice && (
          <Span style={styles.agentIcon.style}>
            {agent && message.message.debateAgentId ? (
              ...
              <Img app={message.message.app || app} size={35} />
            )}
                ...
                {message?.message?.tribePostId && (
                  <A
                    ...
                    onClick={(e) => {
                      ...
                      setIsNewChat({
                        value: true,
                        postId: message.message.tribePostId || undefined,
                      })
                    }}
                  >
