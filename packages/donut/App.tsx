...
function FocusButton({
  ...
  const { focus, getAppSlug, setShowFocus, app, hasHydrated } = useAuth()
      ...
      >
        {hasHydrated && (
          ...
          >
            ...
            >
              {!minimize ? (
                <Img logo="architect" size={22} />
              ) : (
                <Img logo="coder" size={22} />
              )}{" "}
              {!minimize ? t("Machine") : t("My Tribe")}
            </Button>
            {minimize && (
              <Button
                className="link"
          ...
          <>
            ...
            {minimize && hasHydrated && (
              <>
                ...
                >
                  ...
                  <Hippo size={25} dataTestId="minimized-app-hippo" />
              ...
              >
                ...
                >
                  <TextType
                    ...
                    text={[
                      `🔪 ${t("Choose your weapon", { lng: "ja" })} 🏹`,
                      `🧠 ${t("Choose your wisdom", { lng: "ja" })} 🍉`,
                      `🦋 ${t("Choose sovereignty", { lng: "ja" })} 🍩`,
                      `🦄 ${t("Choose your vibe", { lng: "ja" })} 🍣`,
                      `🌀 ${t("Choose your totem", { lng: "ja" })} `,
                    ]}
                    typingSpeed={60}
                    pauseDuration={800}
                    showCursor
            ...
            >
              <Div style={{ ...styles.section.style }}>
                ...
                {isSettingVisible ? (
                  ...
                  !minimize && (
                    ...
                    >
                      <Hippo dataTestId="chat-instructions" size={25} />
                    </Div>
                  )
                )}
              </Div>
              ...
              {!isManagingApp && (
                ...
                >
                  <Div
                    style={{ ...styles.apps.style, overflowWrap: "anywhere" }}
                  >
                              ...
                              >
                                {loadingApp?.id !== chrry?.id ? (
                                  <Img
                                    ...
                                    alt="Chrry"
                                    title={"Chrry"}
                                    width={auth.isP ? 25 : 28}
                                    height={auth.isP ? 25 : 28}
                                  />
                                ) : (
                                  <Loading size={28} />
                                )}
