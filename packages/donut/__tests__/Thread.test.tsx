...
describe("Thread", () => {
  ...
  it.skip("renders thread skeleton and components", async () => {
    await act(async () => {
      root.render(<Thread />)
    })
  ...
  it.skip("renders header actions when not a visitor", async () => {
  ...
  it.skip("shows loading state when loading", async () => {
  ...
  it.skip("handles toggle like correctly", async () => {
    await act(async () => {
      root.render(<Thread />)
    })
  ...
  it.skip("handles character profile update", async () => {
    mockChat.isChatFloating = false
  ...
  it.skip("handles character profile update when floating", async () => {
  ...
  it.skip("handles play audio", async () => {
    await act(async () => {
      root.render(<Thread />)
    })
