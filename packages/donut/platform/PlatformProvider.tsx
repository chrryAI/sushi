...
export function PlatformProvider({
  ...
  const [viewPortWidthInternal, setViewPortWidthInternal] = useLocalStorage(
    "viewPortWidth",
    rest.viewPortWidth,
  )
  ...
  const [viewPortHeightInternal, setViewPortHeightInternal] = useLocalStorage(
    "viewPortHeight",
    rest.viewPortHeight,
  )
  ...
  const [isStorageReady, setIsStorageReady] = useLocalStorage<
    boolean | undefined
  >("_storage_check", undefined)
  ...
  const value = useMemo<PlatformContextValue>(
    () => ({
      ...
      isDesktop,
      isStorageReady: isStorageReady === undefined ? false : !!isStorageReady,
      // IDE state
      isIDE,
      toggleIDE,
      idePanelWidth,
