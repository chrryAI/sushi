...
[![npm](https://img.shields.io/npm/v/@chrryai/donut)](https://www.npmjs.com/package/@chrryai/donut)
...
```bash
npm install @chrryai/donut
# or
pnpm add @chrryai/donut
# or
yarn add @chrryai/donut
```
...
```tsx
import { Chat, Button, Modal } from "@chrryai/donut";
import { Star } from "@chrryai/donut/icons";
...
```tsx
import ChrryAI from "@chrryai/donut/ChrryAI";
...
```tsx
import { ThemeProvider } from "@chrryai/donut/context/providers";
...
```tsx
import { locale } from "@chrryai/donut/locales";
...
- **GitHub:** [@chrryai/donut](https://github.com/chrryai/chrry)
- **npm:** [@chrryai/donut](https://www.npmjs.com/package/@chrryai/donut)
