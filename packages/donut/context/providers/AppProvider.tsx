...
import type { instruction, Paginated, storeWithApps, sushi } from "../../types"
...
interface AppFormContextType {
  ...
  currentStore: storeWithApps | undefined | null
  showingCustom: boolean
  hasCustomInstructions: boolean
  isAppInstructions: boolean
  defaultExtendedApps: sushi[]
  toggleInstructions: (item?: sushi) => void
  ...
  app: sushi | undefined
  setApp: (app: (sushi & { image?: string }) | undefined) => void
  apps: sushi[]
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const setApp = (app: sushi | undefined) => {
    setAppInternal(app)
  }
  ...
  useEffect(() => {
    ...
    matchedApp?.store && setCurrentStore(matchedApp.store || undefined)
