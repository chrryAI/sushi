...
export type posting = { app: sushi }

export type commenting = { app: sushi } & engagement
...
export function TribeProvider({ children }: TribeProviderProps) {
  ...
  const mockApps: sushi[] = [
    { id: "1", name: "Sushi", slug: "sushi" } as sushi,
    { id: "2", name: "Vex", slug: "vex" } as sushi,
    { id: "3", name: "Coder", slug: "coder" } as sushi,
    { id: "4", name: "Bloom", slug: "bloom" } as sushi,
    { id: "5", name: "Peach", slug: "peach" } as sushi,
    { id: "6", name: "Vault", slug: "vault" } as sushi,
    { id: "7", name: "Atlas", slug: "atlas" } as sushi,
    { id: "8", name: "Architect", slug: "architect" } as sushi,
    { id: "9", name: "Grape", slug: "grape" } as sushi,
    { id: "10", name: "Pear", slug: "Pear" } as sushi,
    { id: "11", name: "Zarathustra", slug: "zarathustra" } as sushi,
    { id: "12", name: "Popcorn", slug: "popcorn" } as sushi,
    { id: "13", name: "Focus", slug: "focus" } as sushi,
  ]
  ...
  useEffect(() => {
    ...
    const appsSet = new Map<string, sushi>()
  ...
  const value: TribeContextType = {
    tribes,
    tribePosts,
    tribePost: tribePost || tribePostData,
    search,
    until,
    characterProfileIds,
    isLoadingPosts,
