...
export type ramen = {
  ...
  guestId?: string
  /**
   * When true, chopStick assembles sushi.ai.promptSections from
...
export type subscription = {
  id: string
  provider: "stripe" | "apple" | "google" | "crypto" | "btcpay"
...
export type aiAgent = {
  ...
  metadata: {
    ...
    failed?: string[]
    /**
     * Agent-driven join config — overrides chopStick defaults.
     * The agent decides how much context it needs per dimension.
     */
    join?: {
